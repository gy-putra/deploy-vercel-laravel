...
use App\Filament\Resources\HalalTourPackageResource\Pages;
...
class HalalTourPackageResource extends Resource
{
    protected static ?string $model = HalalTourPackage::class;
                ...
                Section::make('Package Information')
                    ->schema([
                        ...
                        Forms\Components\TextInput::make('country')
                            ->required()
                            ->maxLength(255)
                            ->placeholder('e.g., Turkey, UAE, Egypt'),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('full_destination')
                    ->label('Destination')
    ...
    {
        return [
            'index' => Pages\ListHalalTourPackages::route('/'),
            'create' => Pages\CreateHalalTourPackage::route('/create'),
            'view' => Pages\ViewHalalTourPackage::route('/{record}'),
            'edit' => Pages\EditHalalTourPackage::route('/{record}/edit'),
        ];
    }
}